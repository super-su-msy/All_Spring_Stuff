...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.karan.jaxws.service.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8180/SOAP_Service/services/PersonServiceImpl";
    ...
    public com.karan.jaxws.service.PersonServiceImpl getPersonServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.karan.jaxws.service.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.karan.jaxws.service.PersonServiceImplSoapBindingStub _stub = new com.karan.jaxws.service.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.karan.jaxws.service.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.karan.jaxws.service.PersonServiceImplSoapBindingStub _stub = new com.karan.jaxws.service.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.jaxws.karan.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.jaxws.karan.com", "PersonServiceImpl"));
        }
