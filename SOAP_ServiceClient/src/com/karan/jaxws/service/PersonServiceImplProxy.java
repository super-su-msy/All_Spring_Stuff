...
public class PersonServiceImplProxy implements com.karan.jaxws.service.PersonServiceImpl {
  private String _endpoint = null;
  private com.karan.jaxws.service.PersonServiceImpl personServiceImpl = null;
  ...
  private void _initPersonServiceImplProxy() {
    try {
      personServiceImpl = (new com.karan.jaxws.service.PersonServiceImplServiceLocator()).getPersonServiceImpl();
  ...
  public com.karan.jaxws.service.PersonServiceImpl getPersonServiceImpl() {
    if (personServiceImpl == null)
      _initPersonServiceImplProxy();
