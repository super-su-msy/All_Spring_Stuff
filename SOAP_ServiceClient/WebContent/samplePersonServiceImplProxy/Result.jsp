...
<jsp:useBean id="samplePersonServiceImplProxyid" scope="session" class="com.karan.jaxws.service.PersonServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.karan.jaxws.service.PersonServiceImpl getPersonServiceImpl10mtemp = samplePersonServiceImplProxyid.getPersonServiceImpl();
...
case 15:
        ...
        %>
        <jsp:useBean id="com1karan1jaxws1beans1Person_1id" scope="session" class="com.karan.jaxws.beans.Person" />
        <%
        com1karan1jaxws1beans1Person_1id.setAge(age_2idTemp);
        com1karan1jaxws1beans1Person_1id.setName(name_3idTemp);
        com1karan1jaxws1beans1Person_1id.setId(id_4idTemp);
        boolean addPerson15mtemp = samplePersonServiceImplProxyid.addPerson(com1karan1jaxws1beans1Person_1id);
...
case 26:
        gotMethod = true;
        com.karan.jaxws.beans.Person[] getAllPersons26mtemp = samplePersonServiceImplProxyid.getAllPersons();
...
case 29:
        ...
        com.karan.jaxws.beans.Person getPerson29mtemp = samplePersonServiceImplProxyid.getPerson(id_5idTemp);
