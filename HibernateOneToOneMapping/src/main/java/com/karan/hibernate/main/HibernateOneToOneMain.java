package com.karan.hibernate.main;
...
import com.karan.hibernate.model.Customer;
import com.karan.hibernate.model.Txn;
import com.karan.hibernate.util.HibernateUtil;
...
public class HibernateOneToOneMain {
	...
	private static Txn buildDemoTransaction() {
		...
		cust.setAddress("Austin, USA");
		cust.setEmail("pavan@gmail.com");
		cust.setName("pavan ");
